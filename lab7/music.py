...
playlist = []
music_folder = "/Users/nurmukhammed/Desktop/KBTU/pp2/lab7/music"
...
background = pygame.image.load(os.path.join("music_elements", "background_image.png"))
...
playb = pygame.image.load(os.path.join("music_elements", "play.png"))
pausb = pygame.image.load(os.path.join("music_elements", "pause.png"))
nextb = pygame.image.load(os.path.join("music_elements", "next.png"))
prevb = pygame.image.load(os.path.join("music_elements", "back.png"))
